const translations = {
  'en': {
    ...
    'terms_section2_content': 'Permission is granted to temporarily download one copy of the materials on TravelSpot for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title, and under this license you may not modify or copy the materials; use the materials for any commercial purpose; attempt to decompile or reverse engineer any software contained on TravelSpot; remove any copyright or other proprietary notations from the materials; or transfer the materials to another person or ",
    'terms_section3_title': 'Disclaimer',
    'terms_section3_content': 'The materials on TravelSpot are provided on an ",
    ...
    'beijing_description': 'Explore Beijing with its iconic Great Wall, Forbidden City, and Temple of Heaven. Experience the rich history and culture of China\',
    ...
    'beijing_attraction_great_wall_of_china_desc': 'One of the world\',
    'beijing_attraction_great_wall_of_china_tips': 'Visit early in the morning to avoid crowds. Wear comfortable shoes as there\',
    ...
    'xian_description': 'Discover Xi\',
    'shanghai_description': 'Visit Shanghai, China\',
    ...
    'xian_attraction_terracotta_army_tips': 'Hire a guide to help understand the significance of what you\',
    'an_city_wall': 'Xi\',
    'an_city_wall_desc': 'The most complete ancient city wall in China, offering bicycle rentals to ride around the entire 14km perimeter.',
    'an_city_wall_tips': 'Rent a bicycle to tour the entire wall - it takes about 2 hours at a leisurely pace.',
    ...
    'xian_attraction_muslim_quarter_tips': 'Visit in the evening when it\',
    'xian_attraction_big_wild_goose_pagoda': 'Big Wild Goose Pagoda',
    'xian_attraction_big_wild_goose_pagoda_desc': 'A famous Buddhist pagoda and landmark of Xi\',
    ...
    'qingdao_attraction_tsingtao_brewery_museum_desc': 'Museum showcasing the history of China\',
    ...
    'qingdao_attraction_no._1_bathing_beach_tips': 'Early morning is the best time for swimming when it\',
    'guilin_description': 'Marvel at Guilin\',
    ...
    'guilin_attraction_elephant_trunk_hill_desc': 'A natural rock formation resembling an elephant drinking from the Li River, one of Guilin\',
    ...
    'yangshuo_description': 'Enjoy Yangshuo\',
    ...
    'zhangjiajie_description': 'Explore Zhangjiajie National Forest Park with its unique pillar-like formations that inspired the \',
    'zhangjiajie_attraction_tianmen_mountain': 'Tianmen Mountain',
    'zhangjiajie_attraction_tianmen_mountain_desc': 'Famous for its natural arch (Heaven\',
    'zhangjiajie_attraction_tianmen_mountain_tips': 'Wear comfortable shoes for the 999 steps to Heaven\',
    ...
    'zhangjiajie_attraction_glass_bridge_desc': 'The world\',
    ...
    'yangshuo_food_beer_fish_desc': 'Yangshuo\',
    ...
    'beijing_food_peking_duck_desc': 'Beijing\',
    ...
    't miss the night market food stalls!': 'Amazing historical sites but be prepared for crowds. The subway system is efficient and easy to navigate. Don\',
    ...
    'xian_food_roujiamo_desc': 'Often called \',
    'xian_food_biangbiang_noodles': 'Biangbiang Noodles',
    'xian_food_biangbiang_noodles_desc': 'Extra wide, hand-pulled noodles topped with chili, vegetables and meat. The character for \',
    'xian_food_yang_rou_pao_mo': 'Yang Rou Pao Mo',
    'xian_food_yang_rou_pao_mo_desc': 'Signature Xi\',
    'an_essential_tour': '2-Day Xi\',
    'an_tour': 'Historical Xi\',
    't miss the muslim quarter for amazing food - the spiced lamb skewers and roujiamo were delicious.': 'The Terracotta Warriors are even more impressive in person! Don\',
    ...
    's food culture amazed me. the history is rich and the locals are very friendly. biangbiang noodles are a must-try!': 'As a Chinese person from the south, Xi\',
    'shanghai_food_xiaolongbao': 'Xiaolongbao',
    'shanghai_food_xiaolongbao_desc': 'Shanghai\',
    ...
    't miss the view from the bund at night when all the pudong skyscrapers are lit up. the metro system is world-class and makes getting around easy.': 'Shanghai is a perfect blend of old and new China. Don\',
    ...
    'qingdao_food_tsingtao_beer_desc': 'The city\',
    ...
    't miss the seafood at pichaiyuan market.': 'Qingdao is a hidden gem! The beaches are clean, the beer is excellent, and the German architecture gives the city a unique character. Don\',
    's some of the best in china!': 'Perfect summer destination with great beaches and amazing food. The city is clean and well-organized. Try the fresh seafood - it\',
    ...
    't miss the countryside around yangshuo as well.': 'The landscape around Guilin is simply magical! The Li River cruise was worth every penny - it feels like sailing through a traditional Chinese painting. Don\',
    've visited in china. the rice noodles are delicious and very cheap. i recommend renting a bicycle in yangshuo to explore the surrounding villages.': 'One of the most beautiful places I\',
    ...
    'footer_description': "Discover the world',
    ...
    'travelguide_beijing_desc': 'A comprehensive guide to exploring Beijing\',
    ...
    'travelguide_xian_title': 'Xi\',
    'travelguide_xian_desc': 'Taste authentic Xi\',
  ...
  'zh-CN': {
    ...
    'terms_section2_content': '允许临时下载TravelSpot上的材料的一份副本，仅供个人、非商业性的临时查看。这是授予许可，而非所有权转让，根据此许可，您不得修改或复制材料；将材料用于任何商业目的；试图反编译或逆向工程TravelSpot上包含的任何软件；从材料中删除任何版权或其他专有标记；或将材料转让给他人或在任何其他服务器上",
    'terms_section3_title': '免责声明',
    'terms_section3_content': 'TravelSpot上的材料按",
    ...
    'an_city_wall': '西安城墙',
    'an_city_wall_desc': '中国最完整的古城墙，提供自行车租赁服务，可以骑行整个14公里的周长。',
    'an_city_wall_tips': '租一辆自行车环城墙骑行 - 以悠闲的速度大约需要2小时。',
    ...
    's fry dumplings, da hu chun': '小杨生煎、大壶春',
    ...
    't miss the night market food stalls!': '令人惊叹的历史遗迹，但要做好应对人群的准备。地铁系统高效且易于导航。不要错过夜市的美食摊位！',
    ...
    'xian_food_roujiamo_desc': '常被称为",
    'xian_food_biangbiang_noodles': '油泼扯面',
    'xian_food_biangbiang_noodles_desc': '超宽的手工拉面，上面浇有辣椒、蔬菜和肉。",
    'xian_food_yang_rou_pao_mo': '羊肉泡馍',
    'xian_food_yang_rou_pao_mo_desc': '西安特色菜——饼泡在羊肉汤中，配以粉丝和腌制大蒜。',
    'an_essential_tour': '西安2日精华游',
    'an_tour': '西安历史之旅',
    't miss the muslim quarter for amazing food - the spiced lamb skewers and roujiamo were delicious.': '兵马俑亲眼看更加令人印象深刻！不要错过回民街的美食——调味羊肉串和肉夹馍都很美味。',
    ...
    's food culture amazed me. the history is rich and the locals are very friendly. biangbiang noodles are a must-try!': '作为一个南方人，西安的食物文化让我惊叹。这里历史丰富，当地人非常友好。油泼扯面是必尝的美食！',
    ...
    't miss the view from the bund at night when all the pudong skyscrapers are lit up. the metro system is world-class and makes getting around easy.': '上海是新旧中国的完美融合。不要错过夜晚从外滩看浦东摩天大楼亮灯的景色。地铁系统世界一流，让出行变得容易。',
    ...
    't miss the seafood at pichaiyuan market.': '青岛是一个隐藏的宝石！海滩干净，啤酒优质，德国建筑赋予城市独特的特色。不要错过啤酒街海鲜市场的海鲜。',
    's some of the best in china!': '完美的夏季目的地，拥有美丽的海滩和美味的食物。城市干净且组织良好。尝试新鲜的海鲜——这是中国最好的海鲜之一！',
    ...
    't miss the countryside around yangshuo as well.': '桂林周围的风景简直是魔幻！漓江游船值得每一分钱——感觉就像在传统中国画中航行。也不要错过阳朔周围的乡村。',
    've visited in china. the rice noodles are delicious and very cheap. i recommend renting a bicycle in yangshuo to explore the surrounding villages.': '这是我在中国参观过的最美丽的地方之一。米粉美味又便宜。我建议在阳朔租自行车探索周围的村庄。',
    ...
    's nest) → water cube': '长城（慕田峪段）→ 奥林匹克公园 → 北京国家体育场（鸟巢）→ 水立方',
    ...
    'an city wall → bell tower → drum tower → muslim quarter → great mosque': '西安城墙 → 钟楼 → 鼓楼 → 回民街 → 大清真寺',
    'an museum': '陕西历史博物馆 → 小雁塔 → 西安博物馆',
    's square → shanghai museum': '外滩 → 南京路 → 人民广场 → 上海博物馆',
    ...
    's cathedral → beer street for dinner': '青岛啤酒博物馆 → 中山公园 → 圣弥厄尔大教堂 → 啤酒街晚餐',
    ...
    'an to beijing, shanghai, and other cities.': '高速列车将西安与北京、上海等城市相连。',
    ...
    'an xianyang international airport (xiy) connects to major cities.': '西安咸阳国际机场（XIY）连接各大城市。',
    ...
    'an xianyang international airport (xiy)': '西安咸阳国际机场（XIY）',
  ...
  'zh-TW': {
    ...
    'terms_section2_content': '允許臨時下載TravelSpot上的材料的一份副本，僅供個人、非商業性的臨時查看。這是授予許可，而非所有權轉讓，根據此許可，您不得修改或複製材料；將材料用於任何商業目的；試圖反編譯或逆向工程TravelSpot上包含的任何軟件；從材料中刪除任何版權或其他專有標記；或將材料轉讓給他人或在任何其他服務器上",
    ...
    'an_city_wall': '西安城牆',
    'an_city_wall_desc': '中國最完整的古城牆，提供自行車租賃服務，可以騎行整個14公里的周長。',
    'an_city_wall_tips': '租一輛自行車環城牆騎行 - 以悠閒的速度大約需要2小時。',
    'xian_attraction_muslim_quarter': '回民街',
    ...
    's fry dumplings, da hu chun': '小楊生煎、大壺春',
    ...
    't miss the night market food stalls!': '令人驚嘆的歷史遺跡，但要做好應對人群的準備。地鐵系統高效且易於導航。不要錯過夜市的美食攤位！',
    ...
    'xian_food_roujiamo_desc': '常被稱為",
    'xian_food_biangbiang_noodles': '油潑扯麵',
    'xian_food_biangbiang_noodles_desc': '超寬的手工拉麵，上面澆有辣椒、蔬菜和肉。",
    'xian_food_yang_rou_pao_mo': '羊肉泡饃',
    'xian_food_yang_rou_pao_mo_desc': '西安特色菜——餅泡在羊肉湯中，配以粉絲和醃製大蒜。',
    'an_essential_tour': '西安2日精華遊',
    'an_tour': '西安歷史之旅',
    't miss the muslim quarter for amazing food - the spiced lamb skewers and roujiamo were delicious.': '兵馬俑親眼看更加令人印象深刻！不要錯過回民街的美食——調味羊肉串和肉夾饃都很美味。',
    ...
    's food culture amazed me. the history is rich and the locals are very friendly. biangbiang noodles are a must-try!': '作為一個南方人，西安的食物文化讓我驚嘆。這裡歷史豐富，當地人非常友好。油潑扯麵是必嚐的美食！',
    ...
    't miss the view from the bund at night when all the pudong skyscrapers are lit up. the metro system is world-class and makes getting around easy.': '上海是新舊中國的完美融合。不要錯過夜晚從外灘看浦東摩天大樓亮燈的景色。地鐵系統世界一流，讓出行變得容易。',
    ...
    't miss the seafood at pichaiyuan market.': '青島是一個隱藏的寶石！海灘乾淨，啤酒優質，德國建築賦予城市獨特的特色。不要錯過啤酒街海鮮市場的海鮮。',
    's some of the best in china!': '完美的夏季目的地，擁有美麗的海灘和美味的食物。城市乾淨且組織良好。嘗試新鮮的海鮮——這是中國最好的海鮮之一！',
    ...
    't miss the countryside around yangshuo as well.': '桂林周圍的風景簡直是魔幻！漓江遊船值得每一分錢——感覺就像在傳統中國畫中航行。也不要錯過陽朔周圍的鄉村。',
    've visited in china. the rice noodles are delicious and very cheap. i recommend renting a bicycle in yangshuo to explore the surrounding villages.': '這是我在中國參觀過的最美麗的地方之一。米粉美味又便宜。我建議在陽朔租自行車探索周圍的村莊。',
    ...
    's nest) → water cube': '長城（慕田峪段）→ 奧林匹克公園 → 北京國家體育場（鳥巢）→ 水立方',
    ...
    'an city wall → bell tower → drum tower → muslim quarter → great mosque': '西安城牆 → 鐘樓 → 鼓樓 → 回民街 → 大清真寺',
    'an museum': '陝西歷史博物館 → 小雁塔 → 西安博物館',
    's square → shanghai museum': '外灘 → 南京路 → 人民廣場 → 上海博物館',
    ...
    's cathedral → beer street for dinner': '青島啤酒博物館 → 中山公園 → 聖彌厄爾大教堂 → 啤酒街晚餐',
    ...
    'an to beijing, shanghai, and other cities.': '高速列車將西安與北京、上海等城市相連。',
    ...
    'march to may and september to november are best.': '3月至5月和9月至11月最佳。',
    'an xianyang international airport (xiy) connects to major cities.': '西安咸陽國際機場（XIY）連接各大城市。',
    ...
    'an xianyang international airport (xiy)': '西安咸陽國際機場（XIY）',
    ...
    'contact_address_label': '地址',
    'contact_address_value': '中國北京市朝陽區範例路88號',
    'contact_online_message_title': '線上訊息',
    'contact_online_message_text': '如需快速回覆，請發送電子郵件或致電給我們，我們將盡快回覆您。',
  ...
  'ko': {
    ...
    'terms_section2_content': 'TravelSpot의 자료를 개인적, 비상업적 일시적 보기 용도로만 일시적으로 한 부 다운로드할 수 있는 권한이 부여됩니다. 이는 소유권 이전이 아닌 라이선스 부여이며, 이 라이선스에 따라 귀하는 자료를 수정하거나 복사할 수 없습니다; 자료를 상업적 목적으로 사용할 수 없습니다; TravelSpot에 포함된 소프트웨어를 역컴파일하거나 역설계하려고 시도할 수 없습니다; 자료에서 저작권 또는 기타 소유권 표시를 제거할 수 없습니다; 또는 자료를 다른 사람에게 전송하거나 다른 서버에 ",
    'terms_section3_title': '면책 조항',
    'terms_section3_content': 'TravelSpot의 자료는 ",
    ...
    'an_city_wall': '시안 성벽',
    'an_city_wall_desc': '중국에서 가장 완벽하게 보존된 고대 성벽으로, 전체 14km 둘레를 자전거로 돌아볼 수 있는 대여 서비스를 제공합니다.',
    'an_city_wall_tips': '전체 성벽을 돌아보기 위해 자전거를 대여하세요 - 여유롭게 타면 약 2시간이 소요됩니다.',
    ...
    's fry dumplings, da hu chun': '양스 프라이 덤플링, 다후춘',
    ...
    't miss the night market food stalls!': '놀라운 역사적 명소들이지만 사람들이 많다는 것을 대비하세요. 지하철 시스템은 효율적이고 탐색하기 쉽습니다. 야시장 음식 가판대를 놓치지 마세요!',
    ...
    'xian_food_roujiamo_desc': '종종 \',
    'xian_food_biangbiang_noodles': '비앙비앙 면',
    'xian_food_biangbiang_noodles_desc': '매우 넓은 수제 면에 고추, 채소, 고기를 얹은 요리. \',
    'xian_food_yang_rou_pao_mo': '양로우 파오모',
    'xian_food_yang_rou_pao_mo_desc': '시안의 대표 요리 - 납작한 빵을 양고기 스튜에 담가 당면과 절인 마늘과 함께 제공.',
    'an_essential_tour': '시안 2일 필수 투어',
    'an_tour': '시안 역사 투어',
    't miss the muslim quarter for amazing food - the spiced lamb skewers and roujiamo were delicious.': '병마용은 직접 보면 더욱 인상적입니다! 무슬림 거리의 놀라운 음식을 놓치지 마세요 - 양념된 양고기 꼬치와 로우자모가 맛있었습니다.',
    ...
    's food culture amazed me. the history is rich and the locals are very friendly. biangbiang noodles are a must-try!': '남부 출신 중국인으로서, 시안의 음식 문화는 저를 놀라게 했습니다. 역사가 풍부하고 현지인들은 매우 친절합니다. 비앙비앙 면은 꼭 맛봐야 합니다!',
    ...
    't miss the view from the bund at night when all the pudong skyscrapers are lit up. the metro system is world-class and makes getting around easy.': '상하이는 중국의 옛것과 새것이 완벽하게 조화를 이룹니다. 밤에 푸동의 모든 고층 빌딩이 불을 밝힐 때 외탄에서 보는 전망을 놓치지 마세요. 지하철 시스템은 세계적 수준으로 이동이 쉽습니다.',
    ...
    't miss the seafood at pichaiyuan market.': '칭다오는 숨겨진 보석입니다! 해변은 깨끗하고, 맥주는 훌륭하며, 독일 건축물이 도시에 독특한 특성을 부여합니다. 피차이위안 시장의 해산물을 놓치지 마세요.',
    's some of the best in china!': '훌륭한 해변과 놀라운 음식이 있는 완벽한 여름 목적지. 도시는 깨끗하고 잘 정돈되어 있습니다. 신선한 해산물을 시도해보세요 - 중국에서 가장 좋은 해산물 중 하나입니다!',
    ...
    't miss the countryside around yangshuo as well.': '구이린 주변의 풍경은 정말 마법 같습니다! 리강 크루즈는 모든 비용이 아깝지 않았습니다 - 전통 중국 그림 속을 항해하는 느낌입니다. 양쑤오 주변의 시골도 놓치지 마세요.',
    've visited in china. the rice noodles are delicious and very cheap. i recommend renting a bicycle in yangshuo to explore the surrounding villages.': '중국에서 방문한 가장 아름다운 곳 중 하나입니다. 쌀국수는 맛있고 매우 저렴합니다. 주변 마을을 탐험하기 위해 양쑤오에서 자전거를 빌리는 것을 추천합니다.',
    ...
    'an to beijing, shanghai, and other cities.': '고속철도는 시안을 베이징, 상하이 및 기타 도시와 연결합니다.',
    ...
    'an xianyang international airport (xiy) connects to major cities.': '시안 셴양 국제공항(XIY)은 주요 도시와 연결됩니다.',
    ...
    'an xianyang international airport (xiy)': '시안 셴양 국제공항(XIY)',
